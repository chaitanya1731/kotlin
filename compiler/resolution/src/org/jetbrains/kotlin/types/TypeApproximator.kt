...
//              }
    ...
    private fun isIntersectionTypeIsEffectivelyNothing(constructor: IntersectionTypeConstructor): Boolean {
            ...
            when (effectiveVariance) {
                ...
                TypeVariance.OUT, TypeVariance.IN -> {
                    if (
                        ...
                        if (intersectionTypeConstructor != null && isIntersectionTypeIsEffectivelyNothing(intersectionTypeConstructor)) {
